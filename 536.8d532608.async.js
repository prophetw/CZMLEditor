...
function Cartesian3Value(props) {
  ...
  var addNewItem = function addNewItem() {
    ...
    if (enableTimeInput) {
      setValueAry([].concat(_home_runner_work_CZMLEditor_CZMLEditor_node_modules_pnpm_babel_runtime_7_21_0_node_modules_babel_runtime_helpers_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0___default()(oldAry), [[new (dayjs__WEBPACK_IMPORTED_MODULE_3___default())(Date.now()), 0, 0, 0]]));
    } else {
      setValueAry([].concat(_home_runner_work_CZMLEditor_CZMLEditor_node_modules_pnpm_babel_runtime_7_21_0_node_modules_babel_runtime_helpers_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0___default()(oldAry), [[0, 0, 0]]));
    }
  };
  var deleteItem = function deleteItem(index) {
    ...
    if (oldAry.length === 0) {
      ...
      setValueAry(_home_runner_work_CZMLEditor_CZMLEditor_node_modules_pnpm_babel_runtime_7_21_0_node_modules_babel_runtime_helpers_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0___default()(oldAry));
    }
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ...
    }), valueAry !== null && valueAry.length > 0 && ArrayItem(valueAry), valueAry === null && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(antd__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .ZP, {
      onClick: addNewItem,
      children: "\u65B0\u589E"
    })]
  });
