...
// EXTERNAL MODULE: ./node_modules/.pnpm/@rjsf+antd@5.11.2_@ant-design+icons@5.2.4_@rjsf+core@5.11.2_@rjsf+utils@5.11.2_antd@5.8.1_day_6wq474oouybmleb36qsqinxf2u/node_modules/@rjsf/antd/dist/antd.esm.js + 86 modules
var antd_esm = __webpack_require__(78571);
...
var editableKeysInPacketSchema = ["billboard", "label", "polygon", "polyline", "point", "rectangle", "clock", "model", "position"];
...
function Cartesian3Value(props) {
  ...
  var addNewItem = function addNewItem() {
    if (enableTimeInput) {
      setValueAry([].concat(toConsumableArray_default()(valueAry), [new (dayjs_min_default())(Date.now()), 0, 0, 0]));
    } else {
      setValueAry([].concat(toConsumableArray_default()(valueAry), [0, 0, 0]));
    }
  };
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    }), ArrayItem(valueAry), valueAry.length === 0 && /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.ZP, {
      onClick: addNewItem,
      children: "\u65B0\u589E"
    })]
  });
...
;// CONCATENATED MODULE: ./src/RJSFCustom/CartographicDegreesValue.tsx
...
/* harmony default export */ var RJSFCustom_CartographicDegreesValue = (CartographicDegreesValue);
...
function ColorPickerRGBA(props) {
  ...
  var RGBAFToRGBA = function RGBAFToRGBA(rgbaf) {
    var r = Math.floor(rgbaf[0] * 255);
    var g = Math.floor(rgbaf[1] * 255);
    var b = Math.floor(rgbaf[2] * 255);
    var a = Math.floor(rgbaf[3] * 255);
    return [r, g, b, a];
  };
  var RGBAToRGBAF = function RGBAToRGBAF(rgba) {
    var r = rgba[0] / 255;
    var g = rgba[1] / 255;
    var b = rgba[2] / 255;
    var a = rgba[3] / 255;
...
var Home_widgets = {
  ...
  cartographicDegree_value: RJSFCustom_CartographicDegreesValue,
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.ZP, {
          ...
          alt: ""
        }), /*#__PURE__*/(0,jsx_runtime.jsx)(CZMLIntervalValue, {})]
      })]
    })
  });
};
