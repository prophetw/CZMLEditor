...
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+widgets@3.0.2/node_modules/@cesium/widgets/Source/Viewer/Viewer.js + 626 modules
var Viewer = __webpack_require__(33366);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@3.0.2/node_modules/@cesium/engine/Source/Core/ScreenSpaceEventHandler.js
var ScreenSpaceEventHandler = __webpack_require__(26749);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@3.0.2/node_modules/@cesium/engine/Source/Core/defined.js
var defined = __webpack_require__(49851);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@3.0.2/node_modules/@cesium/engine/Source/Core/Cartographic.js
var Cartographic = __webpack_require__(34984);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@3.0.2/node_modules/@cesium/engine/Source/Core/Math.js
var Core_Math = __webpack_require__(54159);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@3.0.2/node_modules/@cesium/engine/Source/Core/ScreenSpaceEventType.js
var ScreenSpaceEventType = __webpack_require__(77927);
...
// EXTERNAL MODULE: ./src/utils/CZMLRJSFAdaptor.ts + 19 modules
var CZMLRJSFAdaptor = __webpack_require__(17958);
...
var polylineTemplate = {
  "positions": {
    cartographicDegrees: [121, 31.03883, 0, 121.59776, 31.03883, 0]
  }
};
var pointTemplate = {
  "color": {
...
var EditorPage = function EditorPage() {
  ...
  var _useState21 = (0,react.useState)(false),
    ...
    isImportModalOpen = _useState22[0],
    setImportModelOpen = _useState22[1];
  var _useState23 = (0,react.useState)(''),
    _useState24 = slicedToArray_default()(_useState23, 2),
    importJSONStr = _useState24[0],
    setImportJSONStr = _useState24[1];
  var locatePacket = function locatePacket() {
    var isLocateToCurPacket = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    if (cesiumViewer) {
      var dataSources = cesiumViewer.dataSources._dataSources[0];
      if (isLocateToCurPacket && curSelectPacket && dataSources) {
        var entities = dataSources.entities;
        if (entities) {
          var packetId = curSelectPacket.id;
          var entity = entities.getById(packetId);
          if (entity) {
    ...
    if (thumbnailViewer) {
      var _dataSources = thumbnailViewer.dataSources._dataSources[0];
      console.log(' locate ', cesiumViewer, _dataSources);
      if (_dataSources) {
        thumbnailViewer.zoomTo(_dataSources);
      }
    }
  };
  ...
  (0,react.useEffect)(function () {
    ...
    var init = /*#__PURE__*/function () {
      var _ref5 = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime_default()().mark(function _callee5() {
        var packetFromServer, initedPacketAry, clonePakcet, viewer, handler, thumbView;
        return regeneratorRuntime_default()().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              handler = new ScreenSpaceEventHandler/* default */.Z(viewer.scene.canvas);
              handler.setInputAction(function (movement) {
                var cartesian = viewer.scene.pickPosition(movement.position);
                console.log(' ----- cartesian coord ----- ', cartesian);
                if (defined/* default */.Z(cartesian)) {
                  var cartographic = Cartographic/* default.fromCartesian */.Z.fromCartesian(cartesian);
                  console.log(' --- cartographicRadians coord --- ', cartographic);
                  var longitude = Core_Math/* default.toDegrees */.Z.toDegrees(cartographic.longitude);
                  var latitude = Core_Math/* default.toDegrees */.Z.toDegrees(cartographic.latitude);
                  console.log(' --- longitude latitude :', longitude, latitude);
                }
              }, ScreenSpaceEventType/* default.LEFT_CLICK */.Z.LEFT_CLICK);
  ...
  var handleImportOk = function handleImportOk() {
    try {
      var jsonObj = JSON.parse(importJSONStr);
      if (jsonObj && Array.isArray(jsonObj)) {
        ...
        es_message.error('JSON not valid');
      }
    } catch (error) {
      console.error(error);
      es_message.error('JSON not valid');
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.ZP, {
          ...
          title: "Import from JSON string",
          open: isImportModalOpen,
          onOk: handleImportOk,
          onCancel: function onCancel() {
            return setImportModelOpen(false);
          },
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(TextArea/* default */.Z, {
            value: importJSONStr,
            placeholder: "JSON is like below. JSON.stringfy(jsonObject)\n[\n  {\n    \"id\": \"document\",\n    \"name\": \"CZML Template\",\n    \"version\": \"1.0\"\n  },\n  {\n    \"id\": \"packet1\",\n    \"name\": \"Packet title\",\n    \"position\": {\n      \"cartographicDegrees\": [ 121, 31, 22 ]\n    }\n  }\n]\n",
            style: {
              height: 300,
              marginBottom: 24
            },
          ...
          onClick: function onClick() {
            es_message.warning('need implement !');
          },
          children: "Save"
