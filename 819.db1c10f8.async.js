...
var Billboard_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Billboard.json","title":"Billboard","description":"A billboard, or viewport-aligned image. The billboard is positioned in the scene by the `position` property. A billboard is sometimes called a marker.","type":"object","czmlExamples":["Examples/Billboard.json"],"properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the billboard is shown.","default":true},"image":{"$ref":"Uri.json","description":"The URI of the image displayed on the billboard. For broadest client compatibility, the URI should be accessible via Cross-Origin Resource Sharing (CORS). The URI may also be a <a href=\\"https://developer.mozilla.org/en/data_URIs\\">data URI</a>.","czmlRequiredForDisplay":true,"title":"图片"},"scale":{"$ref":"Double.json","description":"The scale of the billboard. The scale is multiplied with the pixel size of the billboard\'s `image`. For example, if the scale is 2.0, the billboard will be rendered with twice the number of pixels, in each direction, of the `image`.","default":1,"title":"缩放"},"pixelOffset":{"$ref":"PixelOffset.json","description":"The offset, in viewport pixels, of the billboard origin from the `position`. A pixel offset is the number of pixels up and to the right to place the billboard, relative to the `position`.","default":"[0.0, 0.0]","title":"偏移量"},"eyeOffset":{"$ref":"EyeOffset.json","description":"The eye offset of the billboard, which is the offset in eye coordinates at which to place the billboard relative to the `position` property. Eye coordinates are a left-handed coordinate system where the X-axis points toward the viewer\'s right, the Y-axis points up, and the Z-axis points into the screen.","default":"[0.0, 0.0, 0.0]"},"horizontalOrigin":{"$ref":"HorizontalOrigin.json","description":"The horizontal origin of the billboard, which determines whether the billboard image is left-, center-, or right-aligned with the `position`.","default":"CENTER","title":"水平对齐方式"},"verticalOrigin":{"$ref":"VerticalOrigin.json","description":"The vertical origin of the billboard, which determines whether the billboard image is bottom-, center-, or top-aligned with the `position`.","default":"CENTER","title":"垂直对齐方式"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the billboard, which indicates if the position is relative to terrain or not.","default":"NONE"},"color":{"$ref":"Color.json","description":"The color of the billboard. This color value is multiplied with the values of the billboard\'s `image` to produce the final color.","default":{"rgba":[255,255,255,255]},"title":"颜色"},"rotation":{"$ref":"Double.json","description":"The rotation of the billboard, in radians, counter-clockwise from the alignedAxis.","default":0},"alignedAxis":{"$ref":"AlignedAxis.json","description":"The aligned axis is the unit vector, in world coordinates, that the billboard up vector points towards. The default is the zero vector, which means the billboard is aligned to the screen up vector."},"sizeInMeters":{"$ref":"Boolean.json","description":"Whether this billboard\'s size (`width` and `height`) should be measured in meters, otherwise size is measured in pixels.","default":false},"width":{"$ref":"Double.json","description":"The width of the billboard, in pixels (or meters, if `sizeInMeters` is true). By default, the native width of the image is used.","title":"宽度"},"height":{"$ref":"Double.json","description":"The height of the billboard, in pixels (or meters, if `sizeInMeters` is true). By default, the native height of the image is used.","title":"高度"},"scaleByDistance":{"$ref":"NearFarScalar.json","description":"How the billboard\'s scale should change based on the billboard\'s distance from the camera. This scalar value will be multiplied by `scale`.","title":"按距离缩放"},"translucencyByDistance":{"$ref":"NearFarScalar.json","description":"How the billboard\'s translucency should change based on the billboard\'s distance from the camera. This scalar value should range from 0 to 1.","title":"按距离透明度"},"pixelOffsetScaleByDistance":{"$ref":"NearFarScalar.json","description":"How the billboard\'s pixel offset should change based on the billboard\'s distance from the camera. This scalar value will be multiplied by `pixelOffset`."},"imageSubRegion":{"$ref":"BoundingRectangle.json","description":"A sub-region of the image which will be used for the billboard, rather than the entire image, measured in pixels from the bottom-left."},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this billboard will be displayed.","title":"按距离显示"},"disableDepthTestDistance":{"$ref":"Double.json","description":"The distance from the camera at which to disable the depth test. This can be used to prevent clipping against terrain, for example. When set to zero, the depth test is always applied. When set to Infinity, the depth test is never applied.","default":0,"title":"显示层级"}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Label.json
var Label_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Label.json","title":"Label","description":"A string of text.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the label is shown.","default":true},"text":{"$ref":"String.json","description":"The text displayed by the label. The newline character (\\\\n) indicates line breaks.","title":"文本"},"font":{"$ref":"Font.json","description":"The font to use for the label.","default":"30px sans-serif","title":"字体"},"style":{"$ref":"LabelStyle.json","description":"The style of the label.","default":"FILL","title":"样式"},"scale":{"$ref":"Double.json","description":"The scale of the label. The scale is multiplied with the pixel size of the label\'s text. For example, if the scale is 2.0, the label will be rendered with twice the number of pixels, in each direction, of the text.","default":1,"title":"缩放"},"showBackground":{"$ref":"Boolean.json","description":"Whether or not a background behind the label is shown.","default":false,"title":"背景"},"backgroundColor":{"$ref":"Color.json","description":"The color of the background behind the label.","default":"[0.165, 0.165, 0.165, 0.8]","title":"背景色"},"backgroundPadding":{"$ref":"BackgroundPadding.json","description":"The amount of padding between the text and the label\'s background.","default":"[7, 5]"},"pixelOffset":{"$ref":"PixelOffset.json","description":"The offset, in viewport pixels, of the label origin from the `position`. A pixel offset is the number of pixels up and to the right to place the label, relative to the `position`.","default":"[0.0, 0.0]","title":"偏移量"},"eyeOffset":{"$ref":"EyeOffset.json","description":"The eye offset of the label, which is the offset in eye coordinates at which to place the label relative to the `position` property. Eye coordinates are a left-handed coordinate system where the X-axis points toward the viewer\'s right, the Y-axis points up, and the Z-axis points into the screen.","default":"[0.0, 0.0, 0.0]"},"horizontalOrigin":{"$ref":"HorizontalOrigin.json","description":"The horizontal origin of the label. It controls whether the label is left-, center-, or right-aligned with the `position`.","default":"CENTER","title":"水平对齐方式"},"verticalOrigin":{"$ref":"VerticalOrigin.json","description":"The vertical origin of the label. It controls whether the label image is bottom-, center-, or top-aligned with the `position`.","default":"CENTER","title":"垂直对齐方式"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the label, which indicates if the position is relative to terrain or not.","default":"NONE"},"fillColor":{"$ref":"Color.json","description":"The fill color of the label.","default":"white","title":"字体颜色"},"outlineColor":{"$ref":"Color.json","description":"The outline color of the label.","default":"black","title":"边线颜色"},"outlineWidth":{"$ref":"Double.json","description":"The outline width of the label.","default":1,"title":"边线宽度"},"translucencyByDistance":{"$ref":"NearFarScalar.json","description":"How the label\'s translucency should change based on the label\'s distance from the camera. This scalar value should range from 0 to 1.","title":"按距离透明度"},"pixelOffsetScaleByDistance":{"$ref":"NearFarScalar.json","description":"How the label\'s pixel offset should change based on the label\'s distance from the camera. This scalar value will be multiplied by `pixelOffset`."},"scaleByDistance":{"$ref":"NearFarScalar.json","description":"How the label\'s scale should change based on the label\'s distance from the camera. This scalar value will be multiplied by `scale`.","title":"按距离缩放"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this label will be displayed.","title":"按距离显示"},"disableDepthTestDistance":{"$ref":"Double.json","description":"The distance from the camera at which to disable the depth test. This can be used to prevent clipping against terrain, for example. When set to zero, the depth test is always applied. When set to Infinity, the depth test is never applied.","default":0,"title":"显示层级"}}}');
...
var Polyline_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Polyline.json","title":"Polyline","description":"A polyline, which is a line in the scene composed of multiple segments.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the polyline is shown.","default":true},"positions":{"$ref":"PositionList.json","description":"The array of positions defining the polyline as a line strip.","czmlRequiredForDisplay":true,"title":"端点"},"arcType":{"$ref":"ArcType.json","description":"The type of arc that should connect the positions of the polyline.","default":"GEODESIC"},"width":{"$ref":"Double.json","description":"The width of the polyline.","default":1,"title":"线宽"},"granularity":{"$ref":"Double.json","description":"The sampling distance, in radians."},"material":{"$ref":"PolylineMaterial.json","description":"The material to use to draw the polyline.","default":{"solidColor":{"color":{"rgba":[255,255,255,255]}}},"title":"材质"},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the polyline casts or receives shadows."},"depthFailMaterial":{"$ref":"PolylineMaterial.json","description":"The material to use to draw the polyline when it is below the terrain."},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying at what distance from the camera this polyline will be displayed.","title":"按距离显示"},"clampToGround":{"$ref":"Boolean.json","description":"Whether or not the polyline should be clamped to the ground.","default":false},"classificationType":{"$ref":"ClassificationType.json","description":"Whether a classification affects terrain, 3D Tiles, or both."},"zIndex":{"$ref":"Integer.json","description":"The z-index of the polyline, used for ordering ground geometry. Only has an effect if the polyline is constant, and `clampToGround` is true."}}}');
...
var Point_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Point.json","title":"Point","description":"A point, or viewport-aligned circle.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the point is shown.","default":true},"pixelSize":{"$ref":"Double.json","description":"The size of the point, in pixels.","default":1,"title":"大小"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the point, which indicates if the position is relative to terrain or not.","default":"NONE"},"color":{"$ref":"Color.json","description":"The color of the point.","default":"white","title":"颜色"},"outlineColor":{"$ref":"Color.json","description":"The color of the outline of the point.","default":"black","title":"外边线颜色"},"outlineWidth":{"$ref":"Double.json","description":"The width of the outline of the point.","default":0,"title":"外边线宽度"},"scaleByDistance":{"$ref":"NearFarScalar.json","description":"How the point\'s scale should change based on the point\'s distance from the camera. This scalar value will be multiplied by `pixelSize`.","title":"按距离缩放"},"translucencyByDistance":{"$ref":"NearFarScalar.json","description":"How the point\'s translucency should change based on the point\'s distance from the camera. This scalar value should range from 0 to 1.","title":"按距离透明度"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this point will be displayed.","title":"按距离显示"},"disableDepthTestDistance":{"$ref":"Double.json","description":"The distance from the camera at which to disable the depth test. This can be used to prevent clipping against terrain, for example. When set to zero, the depth test is always applied. When set to Infinity, the depth test is never applied.","default":0,"title":"显示层级"}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Model.json
var Model_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Model.json","title":"Model","description":"A 3D model.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the model is shown.","default":true},"gltf":{"$ref":"Uri.json","description":"The URI of a <a href=\\"https://github.com/KhronosGroup/glTF\\">glTF</a> model. For broadest client compatibility, the URI should be accessible via Cross-Origin Resource Sharing (CORS). The URI may also be a <a href=\\"https://developer.mozilla.org/en/data_URIs\\">data URI</a>.","czmlRequiredForDisplay":true,"title":"模型"},"scale":{"$ref":"Double.json","description":"The scale of the model.","default":1,"title":"缩放"},"minimumPixelSize":{"$ref":"Double.json","description":"The approximate minimum pixel size of the model regardless of zoom.","default":0,"title":"最小尺寸"},"maximumScale":{"$ref":"Double.json","description":"The maximum scale size of the model. This is used as an upper limit for `minimumPixelSize`.","title":"最大比例"},"incrementallyLoadTextures":{"$ref":"Boolean.json","description":"Whether or not the model can be rendered before all textures have loaded.","default":true},"runAnimations":{"$ref":"Boolean.json","description":"Whether or not to run all animations defined in the glTF model.","default":true,"title":"动画播放"},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the model casts or receives shadows.","default":"ENABLED"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the model, which indicates if the position is relative to terrain or not.","default":"NONE"},"silhouetteColor":{"$ref":"Color.json","description":"The color of the silhouette drawn around the model.","title":"外轮廓颜色"},"silhouetteSize":{"$ref":"Double.json","description":"The size, in pixels, of the silhouette drawn around the model.","default":0,"title":"外轮廓大小"},"color":{"$ref":"Color.json","description":"The color to blend with the model\'s rendered color.","title":"颜色"},"colorBlendMode":{"$ref":"ColorBlendMode.json","description":"The mode to use for blending between `color` and the model\'s color.","default":"HIGHLIGHT","title":"颜色混合模式"},"colorBlendAmount":{"$ref":"Double.json","description":"The color strength when `colorBlendMode` is `MIX`. A value of 0.0 results in the model\'s rendered color while a value of 1.0 results in a solid color, with any value in-between resulting in a mix of the two.","default":0.5,"title":"颜色混合权重"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying at what distance from the camera this model will be displayed.","title":"按距离显示"},"nodeTransformations":{"$ref":"NodeTransformations.json","czmlExamples":["Examples/ModelNodeTransformations.json"]},"articulations":{"$ref":"Articulations.json","czmlExamples":["Examples/ModelArticulations.json"]}}}');
