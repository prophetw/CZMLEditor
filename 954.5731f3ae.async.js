...
var Billboard_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Billboard.json","title":"Billboard","description":"A billboard, or viewport-aligned image. The billboard is positioned in the scene by the `position` property. A billboard is sometimes called a marker.","type":"object","czmlExamples":["Examples/Billboard.json"],"properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the billboard is shown.","default":true},"image":{"$ref":"Uri.json","description":"The URI of the image displayed on the billboard. For broadest client compatibility, the URI should be accessible via Cross-Origin Resource Sharing (CORS). The URI may also be a <a href=\\"https://developer.mozilla.org/en/data_URIs\\">data URI</a>.","czmlRequiredForDisplay":true,"title":"Image"},"scale":{"$ref":"Double.json","description":"The scale of the billboard. The scale is multiplied with the pixel size of the billboard\'s `image`. For example, if the scale is 2.0, the billboard will be rendered with twice the number of pixels, in each direction, of the `image`.","default":1,"title":"Scale"},"pixelOffset":{"$ref":"PixelOffset.json","description":"The offset, in viewport pixels, of the billboard origin from the `position`. A pixel offset is the number of pixels up and to the right to place the billboard, relative to the `position`.","default":"[0.0, 0.0]","title":"Pixel Offset"},"eyeOffset":{"$ref":"EyeOffset.json","description":"The eye offset of the billboard, which is the offset in eye coordinates at which to place the billboard relative to the `position` property. Eye coordinates are a left-handed coordinate system where the X-axis points toward the viewer\'s right, the Y-axis points up, and the Z-axis points into the screen.","default":"[0.0, 0.0, 0.0]"},"horizontalOrigin":{"$ref":"HorizontalOrigin.json","description":"The horizontal origin of the billboard, which determines whether the billboard image is left-, center-, or right-aligned with the `position`.","default":"CENTER","title":"Horizontal Origin"},"verticalOrigin":{"$ref":"VerticalOrigin.json","description":"The vertical origin of the billboard, which determines whether the billboard image is bottom-, center-, or top-aligned with the `position`.","default":"CENTER","title":"Vertical Origin"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the billboard, which indicates if the position is relative to terrain or not.","default":"NONE"},"color":{"$ref":"Color.json","description":"The color of the billboard. This color value is multiplied with the values of the billboard\'s `image` to produce the final color.","default":{"rgba":[255,255,255,255]},"title":"Color"},"rotation":{"$ref":"Double.json","description":"The rotation of the billboard, in radians, counter-clockwise from the alignedAxis.","default":0},"alignedAxis":{"$ref":"AlignedAxis.json","description":"The aligned axis is the unit vector, in world coordinates, that the billboard up vector points towards. The default is the zero vector, which means the billboard is aligned to the screen up vector."},"sizeInMeters":{"$ref":"Boolean.json","description":"Whether this billboard\'s size (`width` and `height`) should be measured in meters, otherwise size is measured in pixels.","default":false},"width":{"$ref":"Double.json","description":"The width of the billboard, in pixels (or meters, if `sizeInMeters` is true). By default, the native width of the image is used.","title":"Width"},"height":{"$ref":"Double.json","description":"The height of the billboard, in pixels (or meters, if `sizeInMeters` is true). By default, the native height of the image is used.","title":"Height"},"scaleByDistance":{"$ref":"NearFarScalar.json","description":"How the billboard\'s scale should change based on the billboard\'s distance from the camera. This scalar value will be multiplied by `scale`.","title":"Scale By Distance"},"translucencyByDistance":{"$ref":"NearFarScalar.json","description":"How the billboard\'s translucency should change based on the billboard\'s distance from the camera. This scalar value should range from 0 to 1.","title":"Translucency By Distance"},"pixelOffsetScaleByDistance":{"$ref":"NearFarScalar.json","description":"How the billboard\'s pixel offset should change based on the billboard\'s distance from the camera. This scalar value will be multiplied by `pixelOffset`."},"imageSubRegion":{"$ref":"BoundingRectangle.json","description":"A sub-region of the image which will be used for the billboard, rather than the entire image, measured in pixels from the bottom-left."},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this billboard will be displayed.","title":"Distance Display Condition"},"disableDepthTestDistance":{"$ref":"Double.json","description":"The distance from the camera at which to disable the depth test. This can be used to prevent clipping against terrain, for example. When set to zero, the depth test is always applied. When set to Infinity, the depth test is never applied.","default":0,"title":"Disable Depth Test Distance"}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Label.json
var Label_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Label.json","title":"Label","description":"A string of text.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the label is shown.","default":true},"text":{"$ref":"String.json","description":"The text displayed by the label. The newline character (\\\\n) indicates line breaks.","title":"Text"},"font":{"$ref":"Font.json","description":"The font to use for the label.","default":"30px sans-serif","title":"Font"},"style":{"$ref":"LabelStyle.json","description":"The style of the label.","default":"FILL","title":"Style"},"scale":{"$ref":"Double.json","description":"The scale of the label. The scale is multiplied with the pixel size of the label\'s text. For example, if the scale is 2.0, the label will be rendered with twice the number of pixels, in each direction, of the text.","default":1,"title":"Scale"},"showBackground":{"$ref":"Boolean.json","description":"Whether or not a background behind the label is shown.","default":false,"title":"Show Background"},"backgroundColor":{"$ref":"Color.json","description":"The color of the background behind the label.","default":"[0.165, 0.165, 0.165, 0.8]","title":"Background Color"},"backgroundPadding":{"$ref":"BackgroundPadding.json","description":"The amount of padding between the text and the label\'s background.","default":"[7, 5]"},"pixelOffset":{"$ref":"PixelOffset.json","description":"The offset, in viewport pixels, of the label origin from the `position`. A pixel offset is the number of pixels up and to the right to place the label, relative to the `position`.","default":"[0.0, 0.0]","title":"Pixel Offset"},"eyeOffset":{"$ref":"EyeOffset.json","description":"The eye offset of the label, which is the offset in eye coordinates at which to place the label relative to the `position` property. Eye coordinates are a left-handed coordinate system where the X-axis points toward the viewer\'s right, the Y-axis points up, and the Z-axis points into the screen.","default":"[0.0, 0.0, 0.0]"},"horizontalOrigin":{"$ref":"HorizontalOrigin.json","description":"The horizontal origin of the label. It controls whether the label is left-, center-, or right-aligned with the `position`.","default":"CENTER","title":"Horizontal Origin"},"verticalOrigin":{"$ref":"VerticalOrigin.json","description":"The vertical origin of the label. It controls whether the label image is bottom-, center-, or top-aligned with the `position`.","default":"CENTER","title":"Vertical Origin"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the label, which indicates if the position is relative to terrain or not.","default":"NONE"},"fillColor":{"$ref":"Color.json","description":"The fill color of the label.","default":"white","title":"Fill Color"},"outlineColor":{"$ref":"Color.json","description":"The outline color of the label.","default":"black","title":"Outline Color"},"outlineWidth":{"$ref":"Double.json","description":"The outline width of the label.","default":1,"title":"Outline Width"},"translucencyByDistance":{"$ref":"NearFarScalar.json","description":"How the label\'s translucency should change based on the label\'s distance from the camera. This scalar value should range from 0 to 1.","title":"Translucency By Distance"},"pixelOffsetScaleByDistance":{"$ref":"NearFarScalar.json","description":"How the label\'s pixel offset should change based on the label\'s distance from the camera. This scalar value will be multiplied by `pixelOffset`."},"scaleByDistance":{"$ref":"NearFarScalar.json","description":"How the label\'s scale should change based on the label\'s distance from the camera. This scalar value will be multiplied by `scale`.","title":"Scale By Distance"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this label will be displayed.","title":"Distance Display Condition"},"disableDepthTestDistance":{"$ref":"Double.json","description":"The distance from the camera at which to disable the depth test. This can be used to prevent clipping against terrain, for example. When set to zero, the depth test is always applied. When set to Infinity, the depth test is never applied.","default":0,"title":"Disable Depth Test Distance"}}}');
...
var Polyline_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Polyline.json","title":"Polyline","description":"A polyline, which is a line in the scene composed of multiple segments.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the polyline is shown.","default":true},"positions":{"$ref":"PositionList.json","description":"The array of positions defining the polyline as a line strip.","czmlRequiredForDisplay":true,"title":"Positions"},"arcType":{"$ref":"ArcType.json","description":"The type of arc that should connect the positions of the polyline.","default":"GEODESIC"},"width":{"$ref":"Double.json","description":"The width of the polyline.","default":1,"title":"Width"},"granularity":{"$ref":"Double.json","description":"The sampling distance, in radians."},"material":{"$ref":"PolylineMaterial.json","description":"The material to use to draw the polyline.","default":{"solidColor":{"color":{"rgba":[255,255,255,255]}}},"title":"Material"},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the polyline casts or receives shadows."},"depthFailMaterial":{"$ref":"PolylineMaterial.json","description":"The material to use to draw the polyline when it is below the terrain."},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying at what distance from the camera this polyline will be displayed.","title":"Distance Display Condition"},"clampToGround":{"$ref":"Boolean.json","description":"Whether or not the polyline should be clamped to the ground.","default":false},"classificationType":{"$ref":"ClassificationType.json","description":"Whether a classification affects terrain, 3D Tiles, or both."},"zIndex":{"$ref":"Integer.json","description":"The z-index of the polyline, used for ordering ground geometry. Only has an effect if the polyline is constant, and `clampToGround` is true."}}}');
...
var Point_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Point.json","title":"Point","description":"A point, or viewport-aligned circle.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the point is shown.","default":true},"pixelSize":{"$ref":"Double.json","description":"The size of the point, in pixels.","default":1,"title":"Pixel Size"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the point, which indicates if the position is relative to terrain or not.","default":"NONE"},"color":{"$ref":"Color.json","description":"The color of the point.","default":"white","title":"Color"},"outlineColor":{"$ref":"Color.json","description":"The color of the outline of the point.","default":"black","title":"Outline Color"},"outlineWidth":{"$ref":"Double.json","description":"The width of the outline of the point.","default":0,"title":"Outline Width"},"scaleByDistance":{"$ref":"NearFarScalar.json","description":"How the point\'s scale should change based on the point\'s distance from the camera. This scalar value will be multiplied by `pixelSize`.","title":"Scale By Distance"},"translucencyByDistance":{"$ref":"NearFarScalar.json","description":"How the point\'s translucency should change based on the point\'s distance from the camera. This scalar value should range from 0 to 1.","title":"Translucency By Distance"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this point will be displayed.","title":"Distance Display Condition"},"disableDepthTestDistance":{"$ref":"Double.json","description":"The distance from the camera at which to disable the depth test. This can be used to prevent clipping against terrain, for example. When set to zero, the depth test is always applied. When set to Infinity, the depth test is never applied.","default":0,"title":"Disable Depth Test Distance"}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Model.json
var Model_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Model.json","title":"Model","description":"A 3D model.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the model is shown.","default":true},"gltf":{"$ref":"Uri.json","description":"The URI of a <a href=\\"https://github.com/KhronosGroup/glTF\\">glTF</a> model. For broadest client compatibility, the URI should be accessible via Cross-Origin Resource Sharing (CORS). The URI may also be a <a href=\\"https://developer.mozilla.org/en/data_URIs\\">data URI</a>.","czmlRequiredForDisplay":true,"title":"Model"},"scale":{"$ref":"Double.json","description":"The scale of the model.","default":1,"title":"Scale"},"minimumPixelSize":{"$ref":"Double.json","description":"The approximate minimum pixel size of the model regardless of zoom.","default":0,"title":"Minimum Pixel Size"},"maximumScale":{"$ref":"Double.json","description":"The maximum scale size of the model. This is used as an upper limit for `minimumPixelSize`.","title":"Maximum Scale"},"incrementallyLoadTextures":{"$ref":"Boolean.json","description":"Whether or not the model can be rendered before all textures have loaded.","default":true},"runAnimations":{"$ref":"Boolean.json","description":"Whether or not to run all animations defined in the glTF model.","default":true,"title":"Run Animations"},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the model casts or receives shadows.","default":"ENABLED"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the model, which indicates if the position is relative to terrain or not.","default":"NONE"},"silhouetteColor":{"$ref":"Color.json","description":"The color of the silhouette drawn around the model.","title":"Silhouette Color"},"silhouetteSize":{"$ref":"Double.json","description":"The size, in pixels, of the silhouette drawn around the model.","default":0,"title":"Silhouette Size"},"color":{"$ref":"Color.json","description":"The color to blend with the model\'s rendered color.","title":"Color"},"colorBlendMode":{"$ref":"ColorBlendMode.json","description":"The mode to use for blending between `color` and the model\'s color.","default":"HIGHLIGHT","title":"Color Blend Mode"},"colorBlendAmount":{"$ref":"Double.json","description":"The color strength when `colorBlendMode` is `MIX`. A value of 0.0 results in the model\'s rendered color while a value of 1.0 results in a solid color, with any value in-between resulting in a mix of the two.","default":0.5,"title":"Color Blend Amount"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying at what distance from the camera this model will be displayed.","title":"Distance Display Condition"},"nodeTransformations":{"$ref":"NodeTransformations.json","czmlExamples":["Examples/ModelNodeTransformations.json"]},"articulations":{"$ref":"Articulations.json","czmlExamples":["Examples/ModelArticulations.json"]}}}');
...
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Box.json
var Box_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Box.json","title":"Box","description":"A box, which is a closed rectangular cuboid.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the box is shown.","default":true},"dimensions":{"$ref":"BoxDimensions.json","description":"The dimensions of the box.","czmlRequiredForDisplay":true},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the box, which indicates if the position is relative to terrain or not.","default":"NONE"},"fill":{"$ref":"Boolean.json","description":"Whether or not the box is filled.","default":true},"material":{"$ref":"Material.json","description":"The material to display on the surface of the box.","default":"solid white"},"outline":{"$ref":"Boolean.json","description":"Whether or not the box is outlined.","default":false},"outlineColor":{"$ref":"Color.json","description":"The color of the box outline.","default":"black"},"outlineWidth":{"$ref":"Double.json","description":"The width of the box outline.","default":1},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the box casts or receives shadows.","default":"DISABLED"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this box will be displayed."}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Shape.json
var Shape_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Shape.json","title":"Shape","description":"A list of two-dimensional positions defining a shape.","allOf":[{"$ref":"DeletableProperty.json"},{"$ref":"ValueProperties/Cartesian2ListValueProperty.json"}],"type":["array","object"],"items":{"$ref":"#"},"properties":{"cartesian2":{"$ref":"Values/Cartesian2ListValue.json","description":"The list of positions specified as two-dimensional Cartesian values `[X, Y, X, Y, ...]`."}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Ellipse.json
var Ellipse_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Ellipse.json","title":"Ellipse","description":"An ellipse, which is a closed curve on or above the surface of the Earth.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the ellipse is shown.","default":true},"semiMajorAxis":{"$ref":"Double.json","description":"The length of the ellipse\'s semi-major axis in meters.","czmlRequiredForDisplay":true},"semiMinorAxis":{"$ref":"Double.json","description":"The length of the ellipse\'s semi-minor axis in meters.","czmlRequiredForDisplay":true},"height":{"$ref":"Double.json","description":"The altitude of the ellipse relative to the surface.","default":"0.0"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the ellipse, which indicates if `height` is relative to terrain or not.","default":"NONE"},"extrudedHeight":{"$ref":"Double.json","description":"The altitude of the ellipse\'s extruded face relative to the surface."},"extrudedHeightReference":{"$ref":"HeightReference.json","description":"The extruded height reference of the ellipse, which indicates if `extrudedHeight` is relative to terrain or not.","default":"NONE"},"rotation":{"$ref":"Double.json","description":"The angle from north (counter-clockwise) in radians.","default":"0.0"},"stRotation":{"$ref":"Double.json","description":"The rotation of any applied texture coordinates.","default":"0.0"},"granularity":{"$ref":"Double.json","description":"The sampling distance, in radians.","default":"π / 180.0"},"fill":{"$ref":"Boolean.json","description":"Whether or not the ellipse is filled.","default":true},"material":{"$ref":"Material.json","description":"The material to use to fill the ellipse.","default":"solid white"},"outline":{"$ref":"Boolean.json","description":"Whether or not the ellipse is outlined.","default":false},"outlineColor":{"$ref":"Color.json","description":"The color of the ellipse outline.","default":"black"},"outlineWidth":{"$ref":"Double.json","description":"The width of the ellipse outline.","default":1},"numberOfVerticalLines":{"$ref":"Integer.json","description":"The number of vertical lines to use when outlining an extruded ellipse.","default":"16"},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the ellipse casts or receives shadows.","default":"DISABLED"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying at what distance from the camera this ellipse will be displayed."},"classificationType":{"$ref":"ClassificationType.json","description":"Whether a classification affects terrain, 3D Tiles, or both.","default":"BOTH"},"zIndex":{"$ref":"Integer.json","description":"The z-index of the ellipse, used for ordering ground geometry. Only has an effect if the ellipse is constant, and `height` and `extrudedHeight` are not specified.","default":"0"}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Cylinder.json
var Cylinder_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Cylinder.json","title":"Cylinder","description":"A cylinder, truncated cone, or cone defined by a length, top radius, and bottom radius.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the cylinder is shown.","default":true},"length":{"$ref":"Double.json","description":"The length of the cylinder.","czmlRequiredForDisplay":true},"topRadius":{"$ref":"Double.json","description":"The radius of the top of the cylinder.","czmlRequiredForDisplay":true},"bottomRadius":{"$ref":"Double.json","description":"The radius of the bottom of the cylinder.","czmlRequiredForDisplay":true},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the cylinder, which indicates if the position is relative to terrain or not.","default":"NONE"},"fill":{"$ref":"Boolean.json","description":"Whether or not the cylinder is filled.","default":true},"material":{"$ref":"Material.json","description":"The material to display on the surface of the cylinder.","default":"solid white"},"outline":{"$ref":"Boolean.json","description":"Whether or not the cylinder is outlined.","default":false},"outlineColor":{"$ref":"Color.json","description":"The color of the cylinder outline.","default":"black"},"outlineWidth":{"$ref":"Double.json","description":"The width of the cylinder outline.","default":1},"numberOfVerticalLines":{"$ref":"Integer.json","description":"The number of vertical lines to draw along the perimeter for the outline.","default":16},"slices":{"$ref":"Integer.json","description":"The number of edges around the perimeter of the cylinder.","default":128},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the cylinder casts or receives shadows.","default":"DISABLED"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this cylinder will be displayed."}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Corridor.json
var Corridor_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Corridor.json","title":"Corridor","description":"A corridor, which is a shape defined by a centerline and width that conforms to the curvature of the globe. It can be placed on the surface or at altitude and can optionally be extruded into a volume.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the corridor is shown.","default":true},"positions":{"$ref":"PositionList.json","description":"The array of positions defining the centerline of the corridor.","czmlRequiredForDisplay":true},"width":{"$ref":"Double.json","description":"The width of the corridor, which is the distance between the edges of the corridor.","czmlRequiredForDisplay":true},"height":{"$ref":"Double.json","description":"The height of the corridor, which is the altitude of the corridor relative to the surface.","default":0},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the corridor, which indicates if `height` is relative to terrain or not.","default":"NONE"},"extrudedHeight":{"$ref":"Double.json","description":"The extruded height of the corridor, which is the altitude of the corridor\'s extruded face relative to the surface."},"extrudedHeightReference":{"$ref":"HeightReference.json","description":"The extruded height reference of the corridor, which indicates if `extrudedHeight` is relative to terrain or not.","default":"NONE"},"cornerType":{"$ref":"CornerType.json","description":"The style of the corners of the corridor.","default":"ROUNDED"},"granularity":{"$ref":"Double.json","description":"The sampling distance, in radians.","default":"π / 180.0"},"fill":{"$ref":"Boolean.json","description":"Whether or not the corridor is filled.","default":true},"material":{"$ref":"Material.json","description":"The material to display on the surface of the corridor.","default":"solid white"},"outline":{"$ref":"Boolean.json","description":"Whether or not the corridor is outlined.","default":false},"outlineColor":{"$ref":"Color.json","description":"The color of the corridor outline.","default":"black"},"outlineWidth":{"$ref":"Double.json","description":"The width of the corridor outline.","default":1},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the corridor casts or receives shadows.","default":"DISABLED"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this corridor will be displayed."},"classificationType":{"$ref":"ClassificationType.json","description":"Whether a classification affects terrain, 3D Tiles, or both.","default":"BOTH"},"zIndex":{"$ref":"Integer.json","description":"The z-index of the corridor, used for ordering ground geometry. Only has an effect if the corridor is constant, and `height` and `extrudedHeight` are not specified.","default":"0"}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/PolylineVolume.json
var PolylineVolume_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/PolylineVolume.json","title":"PolylineVolume","description":"A polyline with a volume, defined as a 2D shape extruded along a polyline that conforms to the curvature of the globe.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the volume is shown.","default":true},"positions":{"$ref":"PositionList.json","description":"The array of positions defining the center of the polyline volume.","czmlRequiredForDisplay":true},"shape":{"$ref":"Shape.json","description":"The array of positions defining the shape of the volume to be extruded.","czmlRequiredForDisplay":true},"cornerType":{"$ref":"CornerType.json","description":"The style of the corners of the volume.","default":"ROUNDED"},"granularity":{"$ref":"Double.json","description":"The sampling distance, in radians.","default":"π / 180.0"},"fill":{"$ref":"Boolean.json","description":"Whether or not the volume is filled.","default":true},"material":{"$ref":"Material.json","description":"The material to use to fill the volume.","default":"solid white"},"outline":{"$ref":"Boolean.json","description":"Whether or not the volume is outlined.","default":false},"outlineColor":{"$ref":"Color.json","description":"The color of the volume outline.","default":"black"},"outlineWidth":{"$ref":"Double.json","description":"The width of the volume outline.","default":1},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the volume casts or receives shadows.","default":"DISABLED"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying the distance from the camera at which this volume will be displayed."}}}');
;// CONCATENATED MODULE: ./CZMLSchemaJSON/Base/Ellipsoid.json
var Ellipsoid_namespaceObject = JSON.parse('{"$schema":"http://json-schema.org/draft-07/schema#","$id":"https://analyticalgraphicsinc.github.io/czml-writer/Schema/Ellipsoid.json","title":"Ellipsoid","description":"A closed quadric surface that is a three-dimensional analogue of an ellipse.","type":"object","properties":{"show":{"$ref":"Boolean.json","description":"Whether or not the ellipsoid is shown.","default":true},"radii":{"$ref":"EllipsoidRadii.json","description":"The radii of the ellipsoid.","czmlRequiredForDisplay":true},"innerRadii":{"$ref":"EllipsoidRadii.json","description":"The inner radii of the ellipsoid."},"minimumClock":{"$ref":"Double.json","description":"The minimum clock angle of the ellipsoid.","default":0},"maximumClock":{"$ref":"Double.json","description":"The maximum clock angle of the ellipsoid.","default":"2π"},"minimumCone":{"$ref":"Double.json","description":"The minimum cone angle of the ellipsoid.","default":0},"maximumCone":{"$ref":"Double.json","description":"The maximum cone angle of the ellipsoid.","default":"π"},"heightReference":{"$ref":"HeightReference.json","description":"The height reference of the ellipsoid, which indicates if the position is relative to terrain or not.","default":"NONE"},"fill":{"$ref":"Boolean.json","description":"Whether or not the ellipsoid is filled.","default":true},"material":{"$ref":"Material.json","description":"The material to display on the surface of the ellipsoid.","default":"solid white"},"outline":{"$ref":"Boolean.json","description":"Whether or not the ellipsoid is outlined.","default":false},"outlineColor":{"$ref":"Color.json","description":"The color of the ellipsoid outline.","default":"black"},"outlineWidth":{"$ref":"Double.json","description":"The width of the ellipsoid outline.","default":1},"stackPartitions":{"$ref":"Integer.json","description":"The number of times to partition the ellipsoid into stacks.","default":64},"slicePartitions":{"$ref":"Integer.json","description":"The number of times to partition the ellipsoid into radial slices.","default":64},"subdivisions":{"$ref":"Integer.json","description":"The number of samples per outline ring, determining the granularity of the curvature.","default":128},"shadows":{"$ref":"ShadowMode.json","description":"Whether or not the ellipsoid casts or receives shadows.","default":"DISABLED"},"distanceDisplayCondition":{"$ref":"DistanceDisplayCondition.json","description":"The display condition specifying at what distance from the camera this ellipsoid will be displayed."}}}');
;// CONCATENATED MODULE: ./src/utils/CZMLDefinitions.ts
...
var CZMLDefinitions = czmlSchemaTypeKeymap;
/* harmony default export */ var utils_CZMLDefinitions = (CZMLDefinitions);
...
var BaseJSONSchemaObj = {
  ellipsoid: Ellipsoid_namespaceObject,
  polylineVolume: PolylineVolume_namespaceObject,
  corridor: Corridor_namespaceObject,
  cylinder: Cylinder_namespaceObject,
  ellipse: Ellipse_namespaceObject,
  shape: Shape_namespaceObject,
  box: Box_namespaceObject,
...
var editableKeysInPacketSchema = ["ellipsoid", "polylineVolume", "corridor", "cylinder", "ellipse", "shape", "billboard", "label", "polygon", "polyline", "point", "rectangle", "clock", "model", "position", "path", "box"];
var CZMLRJSFAdaptor_czmlSchemaTypeKeymap = utils_CZMLDefinitions;
...
var CZML2RJSFAdaptor = function CZML2RJSFAdaptor(schemaObj) {
  ...
  schemaObj.definitions = CZMLRJSFAdaptor_czmlSchemaTypeKeymap;
  ...
  for (var key in properties) {
    if (Object.hasOwn(properties, key)) {
      ...
      if (element) {
        ...
        if (CZMLRJSFAdaptor_czmlSchemaTypeKeymap[ref] !== undefined) {
          ...
          continue;
          var pre_obje = CZMLRJSFAdaptor_czmlSchemaTypeKeymap[ref];
          if (pre_obje.type) {
...
/* harmony export */   "N": function() { return /* binding */ uiSchema; }
/* harmony export */ });
var uiSchema = {
  positions: {
    cartesian: {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "y": function() { return /* binding */ CZMLCustomWidgets; }
});
...
// EXTERNAL MODULE: ./node_modules/.pnpm/antd@5.8.1_react-dom@18.1.0_react@18.1.0/node_modules/antd/es/date-picker/index.js + 1 modules
var date_picker = __webpack_require__(96356);
...
;// CONCATENATED MODULE: ./src/RJSFCustom/CZMLIntervalValue.tsx
...
dayjs_min_default()().locale('zh-cn').format();
function DoubleDateTimePicker(props) {
  ...
  if (value) {
    ...
    start = new (dayjs_min_default())(start);
    end = new (dayjs_min_default())(end);
  }
  var _useState = (0,react.useState)(start),
    _useState2 = slicedToArray_default()(_useState, 2),
    startDate = _useState2[0],
    setStartDate = _useState2[1];
  var _useState3 = (0,react.useState)(end),
...
/* harmony default export */ var CZMLIntervalValue = (DoubleDateTimePicker);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/antd@5.8.1_react-dom@18.1.0_react@18.1.0/node_modules/antd/es/input-number/index.js + 15 modules
var input_number = __webpack_require__(93444);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/antd@5.8.1_react-dom@18.1.0_react@18.1.0/node_modules/antd/es/input/TextArea.js + 4 modules
var TextArea = __webpack_require__(84643);
;// CONCATENATED MODULE: ./src/RJSFCustom/Cartesian3Value.tsx
...
function Cartesian3Value(props) {
  ...
  if (value && value.length > 0) {
    if (valueVaryTime) {
      if (!!epoch) {
        ...
        value.map(function (item, index) {
          if (index % 4 === 0) {
            initValue.push([new (dayjs_min_default())(item), value[index + 1], value[index + 2], value[index + 3]]);
          }
        });
      }
    } else {
  ...
  var _useState = (0,react.useState)(valueVaryTime),
    _useState2 = slicedToArray_default()(_useState, 2),
    enableTimeInput = _useState2[0],
    setEnableTimeInput = _useState2[1];
  var _useState3 = (0,react.useState)(!!epoch),
    _useState4 = slicedToArray_default()(_useState3, 2),
    isUseEpoch = _useState4[0],
    setUseEpoch = _useState4[1];
  var _useState5 = (0,react.useState)(initValue),
  ...
  var _useState9 = (0,react.useState)(''),
    ...
    textareaValue = _useState10[0],
    setTextareaValue = _useState10[1];
  (0,react.useEffect)(function () {
    var result = null;
    if (valueAry === null) {} else {
  ...
  var addNewItem = function addNewItem() {
    var oldAry = valueAry ? valueAry : [];
    if (enableTimeInput) {
      setValueAry([].concat(toConsumableArray_default()(oldAry), [[new (dayjs_min_default())(Date.now()), 0, 0, 0]]));
    } else {
      setValueAry([].concat(toConsumableArray_default()(oldAry), [[0, 0, 0]]));
    }
  };
  var deleteItem = function deleteItem(index) {
    ...
    if (oldAry.length === 0) {
      ...
      setValueAry(toConsumableArray_default()(oldAry));
    }
  };
  var toggleEpoch = function toggleEpoch() {
    ...
    setValueAry(toConsumableArray_default()(valueAry));
  };
  var toggleTime = function toggleTime() {
    ...
    valueAry.forEach(function (item, index) {
      if (endEnableTimeInput) {
        if (item.length === 3) {
          if (!isUseEpoch) {
            valueAry[index] = [new (dayjs_min_default())(Date.now()), item[0], item[1], item[2]];
          } else {
            valueAry[index] = [0, item[0], item[1], item[2]];
          }
        }
  ...
  var ArrayItem = function ArrayItem(ary) {
    ...
    return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: ary.map(function (item, index) {
        var _item = slicedToArray_default()(item, 3),
          x = _item[0],
          y = _item[1],
          z = _item[2];
        var time = null;
        ...
        return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          children: [enableTimeInput && !isUseEpoch && /*#__PURE__*/(0,jsx_runtime.jsx)(date_picker/* default */.Z, {
            value: time,
            onChange: function onChange(date) {
              item[0] = date;
              setValueAry(toConsumableArray_default()(valueAry));
            ...
            showTime: true
          }), enableTimeInput && isUseEpoch && /*#__PURE__*/(0,jsx_runtime.jsx)(input_number/* default */.Z, {
            value: time,
  ...
  var getValue = function getValue() {
    ...
    valueAry.forEach(function (item, index) {
      if (enableTimeInput) {
        if (isUseEpoch) {
          str += "".concat(item[0], " ").concat(item[1], " ").concat(item[2], " ").concat(item[3], "\n");
        } else {
          str += "".concat(dayjs_min_default()(item[0]).format('YYYY-MM-DD HH:mm:ss'), " ").concat(item[1], " ").concat(item[2], " ").concat(item[3], "\n");
        }
      } else {
        str += "".concat(item[0], " ").concat(item[1], " ").concat(item[2], "\n");
      }
    });
    return str;
  };
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(es_button/* default */.ZP, {
      ...
      children: ["enableTimeInput ", enableTimeInput ? "true" : 'false', " "]
    ...
    }), valueAry !== null && valueAry.length > 0 && ArrayItem(valueAry), valueAry === null && /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.ZP, {
      onClick: addNewItem,
      children: "Add"
    })]
  });
}
/* harmony default export */ var RJSFCustom_Cartesian3Value = (Cartesian3Value);
// EXTERNAL MODULE: ./node_modules/.pnpm/antd@5.8.1_react-dom@18.1.0_react@18.1.0/node_modules/antd/es/color-picker/index.js + 47 modules
var color_picker = __webpack_require__(65617);
;// CONCATENATED MODULE: ./src/RJSFCustom/ColorPickerRGBA.tsx
...
function ColorPickerRGBA(props) {
  ...
  var _useState = (0,react.useState)(targetValue),
    _useState2 = slicedToArray_default()(_useState, 2),
    color = _useState2[0],
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    children: /*#__PURE__*/(0,jsx_runtime.jsx)(color_picker/* default */.Z, {
      value: color,
      onChange: setColor
    })
  });
}
/* harmony default export */ var RJSFCustom_ColorPickerRGBA = (ColorPickerRGBA);
;// CONCATENATED MODULE: ./src/RJSFCustom/ColorPickerRGBAF.tsx
...
/* harmony default export */ var RJSFCustom_ColorPickerRGBAF = (ColorPickerRGBAF);
;// CONCATENATED MODULE: ./src/utils/CZMLWidgets.ts




var widgets = {
  // custom format name => custom widget component 
  double_date_time_picker: CZMLIntervalValue,
  cartesian3_value: RJSFCustom_Cartesian3Value,
  cartographicDegree_value: RJSFCustom_Cartesian3Value,
  cartographicRadians_value: RJSFCustom_Cartesian3Value,
  color_rgba: RJSFCustom_ColorPickerRGBA,
  color_rgbaf: RJSFCustom_ColorPickerRGBAF
};
var CZMLCustomWidgets = widgets;
...
module.exports = JSON.parse('[{"id":"document","name":"CZML Model","version":"1.0"},{"id":"aircraft model","name":"Cesium Air","position":{"cartographicDegrees":[-77,37,10000]},"model":{"gltf":"./car1.glb","scale":2,"minimumPixelSize":128}}]');
